  ...
  if (entityContainerName) {
    ...
    if (entityContainer && entityContainer.$Kind === 'EntityContainer') {
      ...
      containerContent.forEach(element => {
        if (entityContainer[element].$Kind === 'EntitySet') {
...
const oDataConfiguration = (edm, options = {}) => {
  ...
  entitySets.forEach(element => {
    configuration[element] = {maxPageSize: options.maxPageSize || DEFAULT_MAX_PAGE_SIZE}
  })
