...
class ExpressionBuilder extends BaseBuilder {
  ...
  _addListToOutputObj (list) {
    ...
    for (let i = 0, len = list.length; i < len; i++) {
      this._addToOutputObj(new this.ReferenceBuilder(list[i], this._options).build(), false)
  ...
  _expressionElementToSQL (element) {
    ...
    switch (key) {
      ...
      case 'SELECT':
        return this._addToOutputObj(new this.SelectBuilder(element, this._options).build(), true)
      case 'func':
  ...
  _funcOutputFromElement (element) {
    const args = []
