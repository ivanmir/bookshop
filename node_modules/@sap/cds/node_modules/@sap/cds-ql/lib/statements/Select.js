...
class Select extends Where {
  ...
  _getReflectedAssociation (entityName, associationName) {
    const reflectedEntity = cds.reflect(this[MODEL].definitions[entityName])
  ...
  _getEntityNameFromServiceName (serviceName) {
    return this[MODEL].definitions[serviceName].source || this[MODEL].definitions[serviceName].name
  }
  ...
  _addOnCondToWhere (cqn, entity, tableAlias, identifier) {
    const onCond = getOnCond(this[MODEL].definitions[entity.previous].elements[entity.current], entity.current, this[MODEL], tableAlias, identifier)
  ...
  _from (entityName, asName) {
    const projection = Where._processProjections(entityName, this[MODEL])
