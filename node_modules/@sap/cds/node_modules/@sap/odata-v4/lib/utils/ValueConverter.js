...
class ValueConverter {
     ...
     * converted.
     * @param {JsonContentpropertyOrReturnType} formatParams JSON serializing options
     */
        ...
        switch (type) {
            case EdmPrimitiveTypeKind.Binary:
                return this.convertBinary(
                    Buffer.isBuffer(value) ? value : Buffer.from(value, 'base64'),
                    this._getMaxLength(propertyOrReturnType));
            ...
            case EdmPrimitiveTypeKind.Decimal:
                return this.convertDecimal(value,
                    this._getPrecision(propertyOrReturnType), this._getScale(propertyOrReturnType) || 0);
    ...
    _getMaxLength(propertyOrReturnType) {
        if (propertyOrReturnType.getMaxLength() != null) return propertyOrReturnType.getMaxLength();
    ...
    _getPrecision(propertyOrReturnType) {
        if (propertyOrReturnType.getPrecision() != null) return propertyOrReturnType.getPrecision();
        const type = propertyOrReturnType.getType();
    ...
    _getScale(propertyOrReturnType) {
        if (propertyOrReturnType.getScale() != null) return propertyOrReturnType.getScale();
        const type = propertyOrReturnType.getType();
    ...
    convertEnum(type, value) {
        ...
        switch (type.getUnderlyingType()) {
            case EdmPrimitiveTypeKind.Byte: this._valueValidator.validateByte(value); break;
            case EdmPrimitiveTypeKind.SByte: this._valueValidator.validateSByte(value); break;
            case EdmPrimitiveTypeKind.Int16: this._valueValidator.validateInt16(value); break;
            case EdmPrimitiveTypeKind.Int32: this._valueValidator.validateInt32(value); break;
            case EdmPrimitiveTypeKind.Int64: this._valueValidator.validateInt64(value); break;
            default:
        }
