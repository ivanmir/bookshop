...
class ParsePreferHeaderCommand extends Command {
    ...
    execute(next) {
        ...
        const preferHeader = this._request.getHeader(HttpHeader.HeaderNames.PREFER);
        if (preferHeader) {
            ...
            this._requestValidator.validatePreferences(this._request.getPreferences(), this._request.getMethod(),
